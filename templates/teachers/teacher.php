    ...
    <main class="flex-grow container mx-auto my-10 bg-white shadow-md rounded-lg p-6">
        <div class="flex flex-col md:flex-row items-center">
            ...
            <div class="ml-6">
                ...
                <p class="text-lg"><strong>Name:</strong> <?= htmlspecialchars($teacher['full_name']) ?></p>
                <p class="text-lg"><strong>E-mail:</strong> <?= htmlspecialchars($teacher['email']) ?></p>
                <p class="text-lg"><strong>Department</strong> <?= htmlspecialchars($teacher['department']) ?></p>
                <p class="text-lg"><strong>Enrollment Date:</strong> <?= htmlspecialchars($teacher['created_at']) ?></p>
            </div>
        </div>
